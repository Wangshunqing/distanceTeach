...
public class studentUpfile {
	...
	public String getUpFileMessage()
	{
		...
		try{
			String tempFileName=(String)session.getId();//瀹㈡埛session鐨刬d
			File fl=new File("D:/webWorkspace/distanceTeach4/WebRoot/student/homework","tempFileName");
			...
			File f2=new File("D:/webWorkspace/distanceTeach4/WebRoot/student/homework",fileName);
